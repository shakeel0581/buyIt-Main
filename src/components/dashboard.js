          ...
          >
            <Card >
              <CardItem
                ...
                style={{ height: 100, flex: 1, justifyContent: 'center' }}>
                <Image
                  source={{ uri: 'https://images.vexels.com/media/users/3/132103/isolated/preview/2b512b5ece5d914e68950bfdbf73b481-shopping-cart-circle-icon-by-vexels.png' }}
                  style={{ height: 100, width: 100,marginTop:20,marginLeft:20 }}
                />
              </CardItem>
              <CardItem style={{ justifyContent: 'center' }}>
          ...
          >
            <Card>
              <CardItem
                ...
                style={{ height: 100, flex: 1, justifyContent: 'center' }}>
                <Image
                  source={{ uri: 'https://image.flaticon.com/icons/png/128/1828/1828479.png' }}
